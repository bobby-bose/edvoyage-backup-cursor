...
class ResponsiveMCQNotesScreen extends StatefulWidget {
  const ResponsiveMCQNotesScreen({super.key});

  @override
  _ResponsiveMCQNotesScreenState createState() =>
      _ResponsiveMCQNotesScreenState();
}

class _ResponsiveMCQNotesScreenState extends State<ResponsiveMCQNotesScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchMCQTopics() async {
    try {
      ...
      print(
          'Responsive MCQ Topics API Response Status: ${response.statusCode}');
      print('Responsive MCQ Topics API Response Body: ${response.body}');

      if (response.statusCode == 200) {
        final data = json.decode(response.body);

        if (data['status'] == 'success' && data['data'] != null) {
          print('Successfully fetched responsive MCQ topics from API');
      ...
      print('Error fetching responsive MCQ topics: $e');
  ...
  Widget _buildMCQTopicCard(Map<String, dynamic> topic, BuildContext context) {
                  ...
                  if (isTablet && isLandscape) {
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return _buildMCQTopicCard(topics[index], context);
                      },
                    );
                  }
