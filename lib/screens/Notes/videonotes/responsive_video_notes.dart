...
class ResponsiveVideoNotesScreen extends StatefulWidget {
  const ResponsiveVideoNotesScreen({super.key});

  @override
  _ResponsiveVideoNotesScreenState createState() =>
      _ResponsiveVideoNotesScreenState();
}

class _ResponsiveVideoNotesScreenState
    extends State<ResponsiveVideoNotesScreen> {
  ...
  Future<List<Map<String, dynamic>>> fetchVideoTopics() async {
    try {
      ...
      print(
          'Responsive Video Topics API Response Status: ${response.statusCode}');
      print('Responsive Video Topics API Response Body: ${response.body}');

      if (response.statusCode == 200) {
        final data = json.decode(response.body);

        if (data['status'] == 'success' && data['data'] != null) {
          print('Successfully fetched responsive video topics from API');
      ...
      print('Error fetching responsive video topics: $e');
      ...
      return [
        ...
        },
        {
          'id': 6,
          'title': 'Microbiology',
          'description': 'Microbial organisms and infectious diseases',
          'videos_count': 11,
          'is_featured': false,
          'order': 6
        },
        {
          ...
          'description': 'Forensic science and toxicological analysis',
          'videos_count': 7,
          'is_featured': false,
          'order': 7
        },
        {
          ...
          'description': 'Public health and community healthcare',
          'videos_count': 13,
          'is_featured': false,
          'order': 8
        },
                  ...
                  if (isTablet && isLandscape) {
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return _buildVideoTopicCard(topics[index], context);
                      },
                    );
                  }
